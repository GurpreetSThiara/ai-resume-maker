...
export function FeaturedExamplesSection() {
    ...
    const getExperienceBadgeColor = (level: string) => {
        switch (level) {
            ...
            case 'mid': return 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200'
            case 'senior': return 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200'
    ...
    return (
        <section className="relative py-20 px-4 overflow-hidden">
            {/* Background Elements */}
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/50 via-emerald-50/30 to-amber-50/50 pointer-events-none" />
            <div className="absolute top-20 right-10 w-64 h-64 bg-gradient-to-br from-emerald-200/30 to-amber-200/30 rounded-full blur-3xl" />
            <div className="absolute bottom-20 left-10 w-64 h-64 bg-gradient-to-br from-emerald-200/30 to-emerald-200/30 rounded-full blur-3xl" />

            <div className="container mx-auto max-w-7xl relative z-10">
                {/* Section Header */}
                <div className="text-center mb-12">
                    <Badge className="mb-4 text-sm px-4 py-1.5 bg-gradient-to-r from-emerald-600 to-amber-600 text-white border-0">
                        <FileText className="w-4 h-4 mr-2 inline" />
                        Resume Examples
                    </Badge>
                    <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-slate-900 via-emerald-900 to-slate-900 bg-clip-text text-transparent">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-10">
                    {featuredExamples.map((example) => (
                        <Card
                            key={example.id}
                            className="group hover:shadow-xl transition-all duration-300 border-slate-200 hover:border-emerald-300 bg-white/80 backdrop-blur-sm"
                        >
                            <CardHeader>
                            ...
                            <CardContent>
                                ...
                                <Button
                                    ...
                                    className="w-full bg-gradient-to-r from-emerald-600 to-amber-600 hover:from-emerald-700 hover:to-amber-700 text-white group-hover:shadow-lg transition-all"
                                >
                                    Use This Example
                ...
                <div className="text-center">
                    <Link href="/resume-examples">
                        <Button
                            size="lg"
                            variant="outline"
                            className="group border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white transition-all"
                        >
