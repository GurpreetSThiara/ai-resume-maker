    ...
    <div className="text-gray-900 font-helvetica p-8">
      ...
      <div className="mb-8">
        <div className="flex flex-wrap gap-x-2">
          <span
            ...
            className="text-2xl font-bold tracking-tight outline-none focus:ring-2 focus:ring-blue-300 rounded px-1"
          >
            {applicant.firstName}
          </span>
          <span
        ...
        <p
          ...
          className="text-gray-600 mb-2 outline-none focus:ring-2 focus:ring-blue-300 rounded px-1"
        >
        ...
        <div className="mb-8">
          ...
          {recipient.address && (
            <p
              ...
              className="text-sm whitespace-pre-line outline-none focus:ring-2 focus:ring-blue-300 rounded px-1"
            >
              {recipient.address}
            </p>
          )}
      ...
      <div className="space-y-4">
        <p
          ...
          className="outline-none focus:ring-2 focus:ring-blue-300 rounded px-1 text-justify"
        >
          {opening}
        </p>
