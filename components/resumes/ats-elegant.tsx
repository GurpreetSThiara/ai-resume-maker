...
export const ElegantATSResume: React.FC<ResumeProps> = ({
  pdfRef,
  font,
  theme,
  resumeData,
  ...
  return (
    <div ref={pdfRef} className={`bg-gray-50 min-h-screen p-6 ${font.className}`} style={{ fontFamily: font.name }}>
      <div className="max-w-3xl mx-auto bg-white shadow rounded-xl overflow-hidden">
        <div className="bg-indigo-50 p-6" ref={personalInfoRef}>
          <h1 className="text-4xl font-bold text-gray-900" contentEditable suppressContentEditableWarning onBlur={handleNameChange}>
            {resumeData.name}
          </h1>
          <div className="flex flex-wrap gap-4 mt-3 text-sm text-gray-600">
            ...
            {resumeData.linkedin && (
              <a href={resumeData.linkedin} target="_blank" rel="noopener noreferrer" className="text-indigo-600 underline">
        ...
        <div className="p-8" ref={customFieldsRef}>
